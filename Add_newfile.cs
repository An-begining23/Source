...
// This header can be included in other files to maintain consistency and avoid duplication.
// For example, you can use it in your test files like this:
// using Source_Test_Git;
